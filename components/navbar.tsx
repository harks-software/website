                        ...
                        >
                            ...
                            >
                                ...
                                <ul className="bg-white">
                                    <li className="cursor-pointer rounded-lg transition-all duration-300 hover:bg-gray-300">
                                        <a href="/youth-day">Youth Day</a>
                                    </li>
                                    <li className="cursor-pointer rounded-lg transition-all duration-300 hover:bg-gray-300">
                                        <a href="/podcast">The HARKS Podcast</a>
                                    </li>
                                    <li className="cursor-pointer rounded-lg transition-all duration-300 hover:bg-gray-300">
                                        <a href="/majlis-shorts">Majlis Shorts</a>
                                    </li>
                                </ul>
                            </li>
                            <li
                            ...
                            >
                                ...
                                <ul className="w-44 bg-white">
                                    <li className="cursor-pointer rounded-lg transition-all duration-300 hover:bg-gray-300">
                                        <a href="/virtual-majlis-service">Virtual Majlis Service</a>
                                    </li>
                                </ul>
                            </li>
