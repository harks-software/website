      ...
      <div className="bg-beige.300 bg-contain">
        <div className="bg-[url('/assets/contact/overlay.png')] bg-no-repeat">
          <div className="mx-auto flex max-w-5xl flex-col gap-6 bg-contain px-4 py-6">
            ...
            <p>
              Kindly fill out the form below if you have any queries at all,
              from questions to inquiries or concerns. You are also welcome to
              give us any feedback or ideas that you may have so we can continue
              to provide you with the best possible content and services
              Insha&apos;Allah!
            </p>
