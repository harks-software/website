...
export default function WhatsAppBroadcasting() {
    return (
        <MainLayout bottomPadding title="WhatsApp Broadcasting">
            <h1
                className={`pt-12 pb-10 text-center ${oswald.className} text-3xl text-gray-600 md:pt-32`}
            >
            ...
            <div className="mx-auto my-0 w-full max-w-5xl rounded-xl px-5 py-10 shadow-[0px_0px_10px_0px_rgba(0,0,0,0.1)]">
                <h2 className="mx-auto w-full text-center text-xl font-bold md:w-[75%]">
                    Join our Whatsapp free broadcasting list and recieve live updates. Please follow
                    the steps below:
                </h2>
                <ul className="mx-auto w-fit px-5 py-10">
                    <li className="mb-5 flex">
                        ...
                        <span>
                            Add our number "<strong>+44 7784 313 786</strong>" to your contacts &
                            save it as "Hussain's Ark of Salvation".
                        </span>
                    </li>
                    <li className="mb-5 flex">
                    ...
                    <li className="flex">
                        ...
                        <span>
                            You will then get updates of our <strong>LIVE events & programs</strong>{" "}
