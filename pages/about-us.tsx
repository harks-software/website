        ...
        <MainLayout bottomPadding={false}>
            <div className={`w-full bg-cream ${montserrat.className}`}>
                <p className="mx-auto w-full px-3 py-8 text-center text-xs font-semibold text-gray-800 md:max-w-[80%] md:pt-10 md:text-xl">
                    Learn more about us and the scope of our mission in strengthening our bond
                    between the AhlulBayt (A.S) and our beloved, your beloved Imam Hussain (A.S).
                </p>
                <div
                    className="w-full"
                    style={{
                ...
                <div className="mt-3 hidden bg-black py-3 sm:flex sm:flex-row sm:py-6">
                    ...
                    <div className="mr-3 flex basis-[40%] items-center justify-center bg-cream p-2 text-center font-montserrat text-xs font-bold text-[#282828] sm:mr-6 sm:p-5 md:text-lg lg:basis-[25%] lg:text-xl">
                        To establish a digital hub and engage the global community to get closer to
                        Allah (S.W.T) through the Holy Qur&lsquo;an and the AhlulBayt (A.S) in a
                        fast changing world.
                    </div>
                ...
                <div className="mt-3 sm:hidden">
                    ...
                    <div className="flex w-full bg-[#303030] pt-2">
                        <div className="flex basis-[80%] items-center justify-center p-5 text-xs text-white">
                            To establish a digital hub and engage the global community to get closer
                            to Allah (S.W.T) through the Holy Qur&lsquo;an and the AhlulBayt (A.S)
                ...
                <div className="flex flex-row py-3 px-5 sm:py-8 lg:px-20">
                    <div className="mr-5 basis-[95%] lg:mr-10">
                        <p className="max-w-[80%] text-xs font-bold leading-5 text-[#282828] md:text-lg md:leading-10">
                            ...
                            organisation which aims to help individuals and communities get closer
                            to God through the love and teachings of the Holy Qur&lsquo;an and the
                            AhlulBayt (A.S).
                        </p>
                        <div className="mt-5 flex w-full flex-row">
                            ...
                            >
                                ...
                                >
                                    Living in a technology-driven world, we believe it is crucial to
                                    use digital innovation to strengthen our faith and uplift
                ...
                <div className="flex items-center bg-[#303030] px-5 py-3 pr-0 text-xs text-cream sm:py-8 sm:pr-5 md:text-lg lg:px-20">
                    <p className="basis-[70%] leading-10">
                        We want to onboard the global community onto the Ark of Aba Abdillah (A.S)
                        and sail towards the Almighty, in a modernistic world.
                    </p>
                    ...
                    <div className="hidden sm:block">
                        <div className="mb-4 flex w-full">
                            ...
                            <label className="swap mr-4 w-[19%] items-center justify-center bg-white/80 p-2 text-center text-lg font-bold lg:text-2xl">
                                ...
                                >
                                    With everything that we do, we aim to positively impact the life
                                    of an individual or a community - all in service to Aba Abdillah
                                    (A.S).
                                </div>
                            </label>
                            <label className="swap mr-4 w-[19%] items-center justify-center bg-white/80 p-2 text-center text-lg font-bold lg:text-2xl">
                            ...
                            <label className="swap mr-4 w-[19%] items-center justify-center bg-white/80 p-2 text-center text-lg font-bold lg:text-2xl">
                                ...
                                <div
                                    ...
                                    style={{ textShadow: "0px 4px 4px rgba(255, 255, 255, 0.5)" }}
                                >
                                    To strengthen the unity and bond that we have with one another.
                                </div>
                            </label>
                            <label className="swap mr-4 w-[19%] items-center justify-center bg-white/80 p-2 text-center text-lg font-bold lg:text-2xl">
                                <input type="checkbox" />
                                ...
                                <div
                                    ...
                                    className="swap-on text-sm"
                                >
                                    To help others around the world by encouraging charitable acts.
                                </div>
                            </label>
                        ...
                        <div className="mb-4 flex">
                            ...
                            <label className="swap mr-4 w-[25%] items-center justify-center bg-white/80 p-2 text-center text-lg font-bold lg:text-2xl">
                                ...
                                <div
                                    ...
                                    className="swap-on text-sm"
                                >
                                    To use technology as a means of getting closer to Allah (S.W.T).
                                </div>
                            </label>
                            <label className="swap mr-4 w-[19%] items-center justify-center bg-white/80 p-2 text-center text-lg font-bold lg:text-2xl">
                                <input type="checkbox" />
                                ...
                                <div
                                    ...
                                    className="swap-on text-sm"
                                >
                                    To be at the forefront of driving innovative digital content in
                    ...
                    <div className="w-full sm:max-w-[70%]">
                        <div className="flex w-full">
                            <div
                                ...
                                style={{
                                    background: "linear-gradient(180deg, #E7AD36 0%, #BE1E2D 100%)",
                                }}
                            ></div>
                            <div
