      ...
      <div className={`w-full bg-cream ${montserrat.className}`}>
        ...
        >
          <div className="flex h-full w-full flex-col items-center">
            ...
            <p className="mt-3 px-3 text-center text-lg font-bold uppercase sm:max-w-[70%] md:mt-5 md:text-4xl md:leading-[50px] lg:max-w-[80%]">
              <span className="text-gray-800">"Verily </span>
        ...
        <div className="mt-3 hidden bg-black py-3 sm:flex sm:flex-row sm:py-6">
          ...
          <div className="mr-3 flex basis-[40%] items-center justify-center bg-cream p-2 text-center font-montserrat text-xs font-bold text-[#282828] sm:mr-6 sm:p-5 md:text-lg lg:basis-[25%] lg:text-xl">
            ...
            closer to Allah (S.W.T) through the Holy Qur’an and the AhlulBayt
            (A.S) in a fast changing world.
          </div>
        ...
        <div className="flex flex-row py-3 px-5 sm:py-8 lg:px-20">
          <div className="mr-5 basis-[95%] lg:mr-10">
            <p className="max-w-[80%] text-xs font-bold leading-5 text-[#282828] md:text-lg md:leading-10">
              Hussain's Ark of Salvation (HARKS) is a global youth-led
              organisation which aims to help individuals and communities get
              closer to God through the love and teachings of the Holy Qur'an
              and the AhlulBayt (A.S).
            </p>
              ...
              >
                ...
                <div className="flex">
                  ...
                  >
                    ...
                    influencers in today's day and age. We strive to introduce
                    new and original ideas to change people's lives through
                    engaging content, in an ever-changing fast environment.
                  </p>
            ...
            <div className="flex w-full">
              ...
              >
                <div className="mr-3 h-full w-[85%] text-xs sm:text-base">
                  ...
                  <span className="font-medium">
                    By applying the teachings of the Holy Qur'an and the
