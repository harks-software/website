        ...
        <MainLayout bottomPadding={false}>
            <div className="bg-cream px-24 pb-12">
                ...
                <div className="mt-8">
                    ...
                    <h1 className="mt-4 text-lg font-semibold lg:text-xl">Interpretation</h1>
                    <p className="mt-4">
                        The words of which the initial letter is capitalized have meanings defined
                        under the following conditions. The following definitions shall have the
                        same meaning regardless of whether they appear in singular or in plural.
                    </p>
                    <h1 className="mt-4 text-lg font-semibold lg:text-xl">Definitions</h1>
                    <p className="mt-2">For the purposes of this Privacy Policy:</p>
                    <ul className="mt-2 list-disc space-y-3 px-5">
                        <li>
                            <p>
                        ...
                        <li>
                            <p>
                                ...
                                &ldquo;Our&rdquo; in this Agreement) refers to Hussains Ark of
                                Salvation.
                            </p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p>
                                <strong>Website</strong> refers to Hussains Ark of Salvation,
                                accessible from{" "}
                                <Link
                                    className="underline"
                                    href="https://hussainsark.com"
                                    rel="noreferrer"
                                    target="_blank"
                                >
                ...
                <div>
                    <h1 className="mt-8 text-2xl font-bold lg:text-3xl">
                        Collecting and Using Your Personal Data
                    </h1>
                    <h1 className="mt-4 text-lg font-semibold lg:text-xl">
                        Types of Data Collected
                    </h1>
                    <h1 className="mt-4 font-semibold">Personal Data</h1>
                    <p className="mt-4">
                    ...
                    <h1 className="mt-4 font-semibold">Usage Data</h1>
                    ...
                    <h1 className="mt-4 font-semibold">Tracking Technologies and Cookies</h1>
                    <p className="mt-4">
                    ...
                    <ul className="mt-4 list-disc space-y-4 px-5">
                        <li>
                    ...
                    <div className="space-y-4">
                        <ul className="mt-4 list-disc px-5">
                            <li>
                    ...
                    <p className="mt-4">We may use Personal Data for the following purposes:</p>
                    <ul className="mt-4 list-disc space-y-4 px-5">
                        <li>
                            <p>
                    ...
                    <h1 className="mt-4 text-lg font-semibold lg:text-xl">Law enforcement</h1>
                    <p className="mt-4">
                    ...
                    <h1 className="mt-8 text-2xl font-bold lg:text-3xl">Children&apos;s Privacy</h1>
                    <p className="mt-8">
                        Our Service does not address anyone under the age of 13 without consent. If
                        We become aware that We have collected Personal Data from anyone under the
                        age of 13 without verification of parental consent, We take steps to remove
                    ...
                    <h1 className="mt-8 text-2xl font-bold lg:text-3xl">Links to Other Websites</h1>
                    <p className="mt-8">
                    ...
                    <div className="mt-8 space-y-4">
                        ...
                        <p>
                            ...
                            prior to the change becoming effective and update the &ldquo;Last
                            updated&rdquo; date at the top of this Privacy Policy.
                        </p>
                        <p>
                    ...
                    <h1 className="mt-4 text-lg font-semibold lg:text-xl">Contact Us</h1>
                    <p className="mt-5">
                    ...
                    <ul className="list-disc px-5">
                        <li>
                            By email:
                            <Link className="underline" href="mailto:hussainsark@gmail.com">
                                hussainsark@gmail.com
                            </Link>
                        </li>
                        <li>
                            ...
                            <Link
                                className="underline"
                                href="https://www.hussainsark.com/contact-us"
                            >
                                https://www.hussainsark.com/contact-us
                            </Link>
                        </li>
                    </ul>
                </div>
