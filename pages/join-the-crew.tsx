...
export default function Index() {
  return (
    <MainLayout title="Join the crew">
      <div
        className={`flex w-full bg-beige.300 bg-[url('/assets/contact/overlay.png')] bg-no-repeat py-4`}
      >
          ...
          <div className="flex flex-col p-6">
            ...
            <div className="py-2">
              ...
              <div className="text-lg font-medium text-[#404040]">
                ...
                world to join us! Bring in fresh ideas, be a part of our vision,
                contribute your skills and get involved in a buzzing environment
                where we all work together to make a true difference in our
          ...
          <div className="flex w-full flex-col items-center md:flex-row md:items-start ">
            ...
            <div className="mt-4 h-[500px] max-w-[725px] bg-[#404040] p-4 md:mt-0 md:ml-auto md:h-[400px]">
              ...
              <div className="text-lg text-white">
                We have an international crew consisting of passionate,
                committed and multi-talented youth working on a wide range of
                projects to support our mission. We believe in empowering the
                youth to become leaders and bring forward ideas that will bring
                individuals and communities closer to God with the love of the
                Holy Qur&apos;an & AhlulBayt (A.S). We try to create an
                atmosphere which encourages team bonding, enhancing skills,
                networking, opportunities and exciting initiatives!
              </div>
            </div>
          </div>
        </div>
      ...
      <div
        className={`flex w-full flex-col truncate bg-beige.300 py-8 pt-6 text-lg font-bold uppercase text-[#28282833] lg:hidden`}
      >
        <div className="mb-3 select-none whitespace-nowrap">
          Planner • Social Media • islamic researcher • streamer • graphic
          Designer • video editor • animation creator • marketing • coordinator
          • uI designer
        </div>
        <div className="mb-3 select-none whitespace-nowrap">
          Streamer • graphic designer • video editor • animator • software
          developer • marketing • Administrator • Planner • Social Media •
          islamic researcher • streamer
        </div>
        <div className="mb-3 select-none whitespace-nowrap">
      ...
      <div
        className={`hidden w-full flex-col truncate bg-beige.300 py-8 text-lg font-bold uppercase text-[#28282833] lg:flex lg:text-2xl`}
      >
        <div className="mb-3 select-none whitespace-nowrap">
          Planner • Social Media • islamic researcher • streamer • graphic
          Designer • video editor • animation creator • marketing • coordinator
      ...
      <div
        className={`-mt-9 flex w-full flex-col p-4 pt-10 lg:mt-0`}
        style={{
          backgroundImage:
            "linear-gradient(180deg, #282828 0%, rgba(40, 40, 40, 0.8) 100%)",
        }}
      >
