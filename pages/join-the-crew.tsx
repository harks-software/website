    ...
    return (
        <MainLayout bottomPadding={false} title="Join the crew">
            ...
            >
                ...
                <div className="mb-3 select-none whitespace-nowrap">
                    graphic Designer • video editor • animation creator • marketing • coordinator •
                    uI designer • Administrator • Planner • Social Media • islamic researcher
                </div>
                <div className="mb-3 select-none whitespace-nowrap">
                    creator • marketing • coordinator • uI designer • software developer • content
                    writer • Administrator • Planner • Social Media • islamic researcher • streamer
                </div>
            </div>
            ...
            >
                ...
                <div className="mt-4 text-center text-2xl font-semibold uppercase text-white md:text-3xl">
                    Are you willing to{" "}
                    <span className="text-3xl font-bold text-red.500 md:text-4xl">commit</span>?
                </div>
