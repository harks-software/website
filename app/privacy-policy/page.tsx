    ...
    <div className="bg-cream px-24 pb-12">
      ...
      <div>
        ...
        <p className="mt-4">
          ...
          as You close Your web browser. You can learn more about cookies on{" "}
          <Link
        ...
        <p className="mt-8">
          Our Service does not address anyone under the age of 13 without
          consent. If We become aware that We have collected Personal Data from
