...
export default function AboutUs() {
  return (
    <div className="w-full bg-cream">
      ...
      <div className="flex flex-row px-5 py-3 sm:py-8 lg:px-20">
      ...
      <div
        className="flex flex-col px-5 py-3 sm:py-8 lg:px-20"
        style={{
          background:
            ...
            >
              <div className="mr-3 h-full w-[85%] text-xs sm:text-base">
                ...
                <span className="font-medium">
                  ...
                  media which addresses the hot topics and practical issues that
                  we face today.
                </span>
              </div>
              <div className="w-[15%]">
          ...
          <div className="flex w-full">
            ...
            >
              ...
              <div className="ml-3 h-full w-[85%] text-right text-xs sm:text-base">
                ...
                <span className="font-medium">
                  By working with other organisations in various ways towards a
                  shared goal.
                </span>
              </div>
            </div>
